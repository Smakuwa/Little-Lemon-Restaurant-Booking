...
const schema = yup.object({
    ...
    telephone: yup.string().required("Telephone is a required field!").matches(/^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$/im, "Phone number must be valid (with country prefix)"),
        ...
        <form onSubmit={handleSubmit(formSubmit)}>
            <fieldset>
                ...
                <div className="field">
                    ...
                    <input type="tel" placeholder="+48575581391" name="telephone" {...register("telephone")}/>
